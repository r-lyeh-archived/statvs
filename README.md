...
network|[Quant (C++03)](https://github.com/r-lyeh/quant) <a href="https://travis-ci.org/r-lyeh/quant"><img src="https://api.travis-ci.org/r-lyeh/quant.svg?branch=master" align="right" /></a> <br/> *quantization suite* to/from half-floats, s/unorm bytes, quats and vec3s.
