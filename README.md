...
encoding|[Base (C++03)](http://github.com/r-lyeh/base) <a href="https://travis-ci.org/r-lyeh/base"><img src="https://api.travis-ci.org/r-lyeh/base.svg?branch=master" align="right" /></a> <br/> *base91/base85/base64* de/encoders.
...
text|[Fmt11 (C++11)](http://github.com/r-lyeh/fmt11) <a href="https://travis-ci.org/r-lyeh/fmt11"><img src="https://api.travis-ci.org/r-lyeh/fmt11.svg?branch=master" align="right" /></a> <br/> tiny *format/mustache templating* library.
...
io|[GetOpt (C++11)](http://github.com/r-lyeh/getopt) <a href="https://travis-ci.org/r-lyeh/getopt"><img src="https://api.travis-ci.org/r-lyeh/getopt.svg?branch=master" align="right" /></a> <br/> simple *command-line options handler*.
